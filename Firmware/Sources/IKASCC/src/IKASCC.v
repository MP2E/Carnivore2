...
//data output enable (wave RAM A7=0, plus compat ch5 read at 98A0-98BF)
assign  o_DB_OE = (sccreg_en & ~i_CS_n & ~i_RD_n &
                  (~i_ABLO[7] | (i_ABLO[7:5] == 3'b101)));
